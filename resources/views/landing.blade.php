      ...
      <div class="box">
            <header>
                  <div class="container" id="cont">
                        <div class="logo">
                              <img src="img/samplelogopic.png" alt="EmpowerLanka_logo">
                              <h3>Empower Lanka </h3>
                        </div>
                        <div class="links">
                              <ul>
                  ...
                  <div class="container">
                        <div class="descript">
                              ...
                              <div class="descrpText">
                                    A small description of some sort i guess... I cant think of anything right now. Lets
                                    add that later with of effects too XD XD
                              </div>
