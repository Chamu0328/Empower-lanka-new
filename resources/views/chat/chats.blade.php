    ...
    <nav>
        <div class="empnavbar">
            <div class="empowerlogo">
                <a href="/home/general"><h2 class="empowerlogo">Empower lanka</h2></a>
            </div>
            <div class="empowerlinks">
                <a href="/home/general"><i class="uil uil-home"></i><label class="linklabel">&nbsp; Home</label></a>
                <a href="/home/general"><i class="uil uil-envelope-minus"></i><label class="linklabel">&nbsp;Notifications</label></a>
